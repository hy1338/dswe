...
-- 【修复】在 UpperTorso(R15)/Torso(R6) 中查找 Neck Motor6D，而非 Head
local function findNeck(character)
    if not character then return nil end
    -- R15: Neck 在 UpperTorso 下
    ...
    -- 兜底：遍历所有 Motor6D 检查 Part1 是否为 Head
...
NameGroup:AddInput("TargetName3Input", { Text = "目标名称 3", Default = "", PlaceholderText = "输入NPC名称关键字", Callback = function(v) SilentAimSettings.TargetName3 = v end end)
