...
-- 主循环 - 使用 Heartbeat 确保在网络发送前执行
AntiAim._connection = RunService.Heartbeat:Connect(function()
            ...
            if char then
                ...
                if head then
                    ...
                    if neck and AntiAim._originalNeckC0 then
                        ...
                        elseif AntiAim.Pitch == "随机" then pitchAngle = math.rad(math.random(-89, 89)) end
                        ...
                        neck.C0 = AntiAim._originalNeckC0 * CFrame.Angles(pitchAngle, math.rad(yawOffset + desyncAngle), 0)
                    end
                end
            end
        end
